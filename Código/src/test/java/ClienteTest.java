...
public class ClienteTest {
    ...
    void criarClienteInvalido() {
        assertThrows(ClienteNaoEncontradoException.class, () -> new Cliente("", "12345678901", "a@a.com"));
        assertThrows(ClienteNaoEncontradoException.class, () -> new Cliente("Ana", "123", "a@a.com"));
        assertThrows(ClienteNaoEncontradoException.class, () -> new Cliente("Ana", "12345678901", "aaa"));
    }
    ...
    void setStatus() {
        Cliente c = new Cliente("Ana", "12345678901", "a@a.com");
        assertThrows(ClienteNaoEncontradoException.class, () -> c.setStatus(null));
    }
}
